const dictionary = [
    ...
    { name: "エンドポータルが開く", id: "block.end_portal.spawn", sounds: ["block/end_portal/endportal"], genre: ["魔法", "システム"] },
    ...
    { name: "経験値が増える", id: "entity.experience_orb.pickup", sounds: ["random/orb"], genre: ["システム"] },
    ...
    { name: "プレイヤーがレベルアップする", id: "entity.player.levelup", sounds: ["random/levelup"], genre: ["システム"] },
    ...
    { name: "ウォーデンが出現", id: "entity.warden.emerge", sounds: ["mob/warden/emerge"], genre: ["システム", "鳴き声", "魔法"] },
    ...
    { name: "ウィザーが頭蓋骨を飛ばす", id: "entity.wither.shoot", sounds: ["mob/wither/shoot"], genre: ["銃", "魔法"] },
    ...
    { name: "UIをクリックする", id: "ui.button.click", sounds: ["random/click"], genre: ["システム"] },
    { name: "地図が書かれる音", id: "ui.cartography_table.take_result", sounds: [["ui/cartography_table/drawmap",3]], genre: ["その他"] },
    { name: "進捗が達成される", id: "ui.toast.challenge_complete", sounds: ["ui/toast/challenge_complete"], genre: ["システム"] }
];
