const dictionary = [
    ...
    { name: "リスポーンアンカーが消耗する", id: "block.respawn_anchor.deplete", sounds: [["block/respawn_anchor/deplete", 2]], genre: ["魔法", "発射"] },
    ...
    { name: "ウィザーが頭蓋骨を飛ばす", id: "entity.wither.shoot", sounds: ["mob/wither/shoot"], genre: ["銃","発射", "魔法","風"] },
